...
`
	...
	fmt.Println("Example Brick Dep:", exampleBrick.Dep2.Value)
	...
	//clone
	cloneBrick2 := brick.Get[ExampleBrick](brick.CloneConfig[ExampleBrick]())
	fmt.Println("Clone Brick ID:", cloneBrick2.ID)
	fmt.Println("Clone Brick Name:", cloneBrick2.Name)
	fmt.Println("Clone Brick Dep:", cloneBrick2.Dep.Value)
	fmt.Println("Clone Brick Dep2:", cloneBrick2.Dep2.Value)
